...
public class BatchAddSvnIgnore {
    ...
    public static void main(String[] args) {
        String path = "D:\\Source\\XLActGroup\\youxi-test\\trunk\\youxi-act-demo";
        ...
        Iterator<File> iterateFiles = FileUtils.iterateFilesAndDirs(directory, FalseFileFilter.INSTANCE, new PrefixFileFilter("youxi-"));
